  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="#">Tambah Data Buku</a></div>
      </div>
    </div>
    ...
    <div class="section-body">
     ...
     @endif
      <h2 class="section-title">Tambah Data Buku</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-start">
                            <div class="col-sm-12">
                                <label>Penulis</label>
                                <input type="text" class="form-control @error('penulis') is-invalid @enderror" name="penulis" placeholder="Penulis">
                                   @error('penulis')
                                        <div class="text-danger">{{ $message }}</div>
                                   @enderror
                            </div>
                        ...
                        <div class="row align-items-start">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control @error('tahun_terbit') is-invalid @enderror" name="tahun_terbit" placeholder="Tahun Terbit">
                                   @error('tahun_terbit')
                                        <div class="text-danger">{{ $message }}</div>
                                   @enderror
                            </div>
